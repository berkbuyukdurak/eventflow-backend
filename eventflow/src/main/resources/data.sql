INSERT INTO presentation (id, name, duration)
VALUES ('d3b7698e-044b-46d8-a45a-8737d915a814', 'Architecting Your Codebase', 60),
       ...
       ('d7fcd776-0742-4100-b963-ff546a5f4560', 'User Interface CSS in Apps', 30) ON CONFLICT (id) DO NOTHING;
